...
public class SIPSessionInfoImpl implements SIPSessionInfo, Serializable {
    ...
    public SIPSessionInfoImpl(SIPRequestInfo requestInfo) {
        ...
        startTime = requestInfo.getDate().getTime();
    ...
    public String toString() {
        ...
        sb.append(", disconnectDelay=").append(getDisconnectDelay());
        sb.append(", establishedTime=").append(getEstablishedTime());
        sb.append(", state=").append(getState());

        sb.append(". Request list: ");
        if (!requests.isEmpty()) {
            for (SIPRequestInfo request : requests) {
                sb.append(request);
        ...
        if (!responses.isEmpty()) {
            for (SIPResponseInfo response : responses) {
                sb.append(response);
